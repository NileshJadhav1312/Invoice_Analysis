"""
Vendor Invoice Intelligence Portal - Streamlit Web Application.
Provides interactive UI for Freight Cost Prediction and Invoice Risk Flagging.
"""
...
# -----------------------------------------------------------------------------
# 4. Module 1: Freight Cost Prediction
# -----------------------------------------------------------------------------
if selected_model == "Freight Cost Prediction":
    ...
    **Objective:**
    ...
    # User input form for freight prediction
    ...
    # Run inference and display estimated freight amount
    if submit_freight:
        input_data = {
            "Quantity": [quantity],
            "Dollars": [dollars],
...
# -----------------------------------------------------------------------------
# 5. Module 2: Invoice Risk Flagging (Manual Approval Detection)
# -----------------------------------------------------------------------------
else:
    ...
    **Objective:**
    ...
    # User input form for invoice risk features
    ...
    # Run inference and display approval recommendation
    if submit_flag:
        input_data = {
